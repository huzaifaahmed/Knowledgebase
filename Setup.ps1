...
# ----------------------------
# Edge Secure DNS (DoH - NextDNS)
# ----------------------------
Write-Host "Edge: configuring Secure DNS (NextDNS)..." -ForegroundColor Yellow

# Enable Secure DNS
New-ItemProperty -Path $edgePolicy -Name "DnsOverHttpsMode" -PropertyType String -Value "secure" -Force | Out-Null

# Set NextDNS endpoint
New-ItemProperty -Path $edgePolicy -Name "DnsOverHttpsTemplates" -PropertyType String -Value "https://dns.nextdns.io/fdc51f" -Force | Out-Null
